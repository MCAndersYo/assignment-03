...
public sealed class WorkItemRepositoryTests : IDisposable
{
    ...
    public WorkItemRepositoryTests()
    {
        ...
        var WorkItem2 = new WorkItem{Title = "Title work Item 2", AssignedTo = User1, Description = "Detailed description!", Tags = new HashSet<Tag>{tag2}};
        var WorkItem3 = new WorkItem{Title = "Title work Item 3", AssignedTo = User2, Description = "Detailed description!", Tags = new HashSet<Tag>{tag1}};
